...
public class Cosine implements Similar{
	
	private String tokens;
	
	public Cosine(String tokens) {
		this.tokens = tokens;
	}
	...
	public boolean similar(String tokens,int similarThreshold) {
		return getSimilarity(this.tokens,tokens)*100>similarThreshold;
	}  
